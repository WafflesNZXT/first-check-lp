    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-white font-sans">
      <div className="max-w-md w-full border border-gray-200 p-10 rounded-[32px] shadow-sm">
        <div className="mb-8">
          ...
          <p className="text-gray-500">Let&apos;s finish setting up your dashboard access.</p>
        </div>
        ...
        {status !== 'success' ? (
          ...
          <div className="py-10">
            ...
            <p className="text-gray-500">Your site has been saved for <strong>{email}</strong>. You can now continue in your dashboard.</p>
          </div>
        )}
      </div>
    </div>
